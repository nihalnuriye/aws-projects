...
app.config['MYSQL_DATABASE_HOST'] = 'database-flask05.c7882wc0w1xt.us-east-1.rds.amazonaws.com'
...
VALUES 
    ("Adem", "adem@amazon.com"),
    ("Nihal", "nihal@google.com"),
    ("Chris", "chris@bmw.com"),
    ("Ugur", "ugur@mercedes.com"),
	("Cagri", "cagri@porche.com");
"""
